...
> **گفتگوهای اخیر و پاریتی فلاتر:**  
> - [`docs/CHATS.md`](docs/CHATS.md) — خلاصه فیچرهای پیاده‌شده در وب/بک‌اند  
> - [`docs/MOBILE_PARITY.md`](docs/MOBILE_PARITY.md) — چک‌لیست انتقال به اپ فلاتر
> - [`mobile/docs/STORE_FLAVORS.md`](mobile/docs/STORE_FLAVORS.md) — فلیور مایکت / بازار / پلی / اپ‌استور
