...
export default function CoachesListClient({ initialItems = [], initialTotal = 0 }) {
  ...
  useEffect(() => {
    // Page 1 is already seeded from the server-rendered HTML; skip the
    // redundant refetch on first mount so crawlers keep the initial markup.
