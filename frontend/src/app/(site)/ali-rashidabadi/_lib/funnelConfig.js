...
export const PAYMENT_COPY = {
  ...
  plansTitle: "انتخاب استراتژی تحول بدنی (دوره ۳ ماهه)",
  plansSubtitle:
    "ترکیبی از پایش ۲۴ ساعته هوش مصنوعی و نظارت مستقیم مربی علی رشیدآبادی",
  vipBadge: "🔥 پیشنهاد اصلی",
  cipBadge: "⭐️ ظرفیت محدود",
  features: [
    {
      icon: "bot",
      sticker: "🤖",
  ...
  transformations: [
    // —— پسران (عکس‌های نمونه فعلی؛ بعداً عوض می‌شوند)
    {
      gender: "male",
      before: "/images/1.png",
      after: "/images/11.png",
      ...
      bodyType: "مزومورف",
      quote:
        "قبلاً هر برنامه‌ای را از هفته سوم رها می‌کردم. اینجا هر روز وزن و تمرینم چک می‌شد؛ مربی همون هفته‌ای که استپ کردم برنامه رو عوض کرد.",
    },
    {
      gender: "male",
      before: "/images/2.png",
      ...
      bodyType: "اندومورف",
      quote:
        "شش ماه باشگاه بدون برنامه فقط خسته شدم. تو فیتینو کالری و حرکت‌ها دقیق شد؛ تو هشت هفته دور شکمم اومد پایین و دیگه ریزه‌خواری شبونه ندارم.",
    },
    {
      gender: "male",
      before: "/images/1.png",
