...
const PILLARS = [
  {
    ...
    desc: "هدایت، بازبینی و تایید مداوم روند پیشرفت شما توسط مربی جهت اطمینان از صحت و کارایی تمام برنامه‌ها.",
  },
  {
    icon: "dumbbell",
...
const STEPS = [
  ...
  },
  {
    ...
    text: "با هدایت مستمر مربی، مسیر تغییرات خود را بدون استپ وزنی و با پایداری کامل طی کنید.",
  },
];
