    ...
    <div className="relative flex h-full flex-col border-l border-white/10 bg-zinc-950">
      ...
      <div className="flex items-center justify-between gap-2 px-4 py-4">
        <Link href="/admin" className="flex items-center gap-2">
          <span className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-linear-to-br from-rose-400/15 to-cyan-400/10 ring-1 ring-white/10">
            <FaDumbbell className="text-rose-200 text-[18px]" />
          </span>
