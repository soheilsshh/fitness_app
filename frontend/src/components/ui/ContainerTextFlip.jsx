...
export function ContainerTextFlip({
  ...
  return (
    <motion.span
      ...
      className={[
        "relative inline-block rounded-xl px-4 pt-1.5 pb-2 text-center text-base font-bold text-emerald-200 md:text-lg",
        "[background:linear-gradient(to_bottom,rgba(16,185,129,0.14),rgba(16,185,129,0.04))]",
        "shadow-[inset_0_-1px_rgba(16,185,129,0.35),inset_0_0_0_1px_rgba(16,185,129,0.2),0_4px_12px_-4px_rgba(16,185,129,0.25)]",
        className,
      ].join(" ")}
