...
type ProgramItem struct {
	...
	// MuscleGroup is the canonical group this movement trains
	// (service.MuscleGroup*), resolved at write time so programs built from
	// coach templates and AI-generated home programs group the same way as the
	// catalog. Empty when it could not be classified.
