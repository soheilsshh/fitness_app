...
func NewServer(db *gorm.DB) *Server {
	...
	router.GET("/coaches/:slug", middleware.OptionalAuthMiddleware(), publicCoachController.GetCoachBySlug)
	router.GET("/coaches/:slug/plans", middleware.OptionalAuthMiddleware(), publicCoachController.GetCoachPlans)
