...
Each page fetches 50 templates and appends them to output/exercise_templates.json.
Re-run to resume if interrupted (continues from the next page).

Usage:
    pip install -r requirements.txt
    python fetch_exercise_templates.py

Test (only 2 pages = 100 templates):
    python fetch_exercise_templates.py --max-pages 2
"""
